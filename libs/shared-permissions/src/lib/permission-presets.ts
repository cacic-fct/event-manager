...
const SPORTS_CATEGORY_TARGET_SCOPES = [
  EventManagerPermissionGrantScope.MajorEvent,
  EventManagerPermissionGrantScope.EventGroup,
] as const;
...
export const EVENT_MANAGER_PERMISSION_PRESETS = [
  ...
  {
    id: 'prize-draw-operator',
    label: 'Operador de sorteios',
    description: 'Configura, executa e corrige sorteios no escopo escolhido.',
    icon: 'rewarded_ads',
  ...
  },
  {
    ...
    label: 'Administrador de torneio',
    description:
      'Gerencia toda a estrutura esportiva, equipes, inscrições, partidas, arbitragem e resultados de um torneio.',
    icon: 'emoji_events',
    preferredScope: EventManagerPermissionGrantScope.MajorEvent,
    allowedScopes: MAJOR_EVENT_SCOPE_ONLY,
    permissions: [
  ...
  },
  {
    ...
    label: 'Revisor de equipes e escalações',
    description:
      'Consulta dados limitados, revisa alterações de equipes e decide inscrições e escalações sem acesso global a pessoas.',
    icon: 'fact_check',
    preferredScope: EventManagerPermissionGrantScope.EventGroup,
    allowedScopes: SPORTS_CATEGORY_TARGET_SCOPES,
    permissions: [
  ...
  },
  {
    ...
    label: 'Operador de partida',
    description:
      'Realiza check-in, controla a partida e registra placares ao vivo no evento, modalidade ou torneio escolhido.',
    icon: 'sports_score',
    preferredScope: EventManagerPermissionGrantScope.Event,
    allowedScopes: EVENT_TARGET_SCOPES,
    permissions: [
