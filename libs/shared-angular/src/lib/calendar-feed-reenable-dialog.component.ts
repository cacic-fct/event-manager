...
@Component({
  ...
  template: `
    ...
    <div mat-dialog-content>
      <p>
        Recomendamos gerar um novo link antes de reativar, por segurança. O link antigo funciona como uma chave: se
        alguém guardou esse endereço, viu em um registro de proxy, recebeu antes ou está com um app de calendário
        comprometido, essa pessoa volta a acessar o feed assim que ele for reativado.
      </p>
      <p>
        Ao gerar um novo link, o endereço antigo deixa de funcionar e só quem receber o novo link poderá usar o feed.
      </p>
    </div>
