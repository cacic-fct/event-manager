...
const meta: Meta<SubscriptionCsvImportResultDialogComponent> = {
  component: SubscriptionCsvImportResultDialogComponent,
...
type Story = StoryObj<SubscriptionCsvImportResultDialogComponent>;
