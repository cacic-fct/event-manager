...
const meta: Meta<WorkspaceEventSubscriptionsSubtabComponent> = {
  component: WorkspaceEventSubscriptionsSubtabComponent,
...
type Story = StoryObj<WorkspaceEventSubscriptionsSubtabComponent>;
