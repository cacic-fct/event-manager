...
const meta: Meta<WorkspaceEventAttendancesSubtabComponent> = {
  component: WorkspaceEventAttendancesSubtabComponent,
  title: 'CACIC Eventos/Workspace/Tabs/Attendances/Workspace Event Attendances Subtab',
  tags: ['autodocs'],
  parameters: {
    layout: 'fullscreen',
    a11y: { test: 'todo' },
...
type Story = StoryObj<WorkspaceEventAttendancesSubtabComponent>;
