const FIELD_LABELS: Record<string, string> = {
  ...
  requiresImageLicenseAgreement: 'Exigir contrato de licença de uso de imagem',
  ...
  imageLicenseAgreementAccepted: 'Concordância com contrato de licença de uso de imagem',
