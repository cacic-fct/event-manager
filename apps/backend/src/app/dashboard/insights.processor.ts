...
import { DASHBOARD_INSIGHTS_QUEUE, DashboardInsightsService } from './insights.service';
...
export class DashboardInsightsProcessor extends WorkerHost {
  ...
  async process(job: Job): Promise<void> {
    if (job.name === 'refresh-realtime-dashboard-insights' || job.name === 'refresh-operational-dashboard-insights') {
