...
import { PublicationPreviewInput, PublicationPreviewPayload, PublicationPreviewResult } from './publishing.models';
...
export class PublicationPreviewService {
  ...
  async createPreview(input: PublicationPreviewInput, context: GraphqlContext): Promise<PublicationPreviewResult> {
