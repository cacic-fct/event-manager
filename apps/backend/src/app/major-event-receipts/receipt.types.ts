...
export const RECEIPT_PDF_PROCESSING_TIMEOUT_MS = 15_000;
export const MAX_RECEIPT_PDF_TEXT_BYTES = 1_000_000;
export const MAX_RECEIPT_PDF_PAGES = 10;
export const MAX_RECEIPT_PDF_PAGE_PREVIEW_DIMENSION_PIXELS = 1_000;
