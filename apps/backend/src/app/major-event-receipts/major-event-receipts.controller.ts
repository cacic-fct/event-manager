...
export class MajorEventReceiptsController {
  ...
  @UseGuards(ThrottlerGuard, ReceiptUploadTurnstileGuard)
  @Throttle({
    default: {
      limit: 4,
      ttl: 60_000,
  ...
  @ApiHeader({
    ...
    required: true,
    description:
      'Cloudflare Turnstile response token generated by the receipt upload form. This header is validated before multipart parsing so invalid uploads are rejected before file parsing starts.',
    schema: {
      type: 'string',
    },
    example: '0.xxx',
