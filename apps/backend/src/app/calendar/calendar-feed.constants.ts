...
export const CALENDAR_FEED_ENTRY_LIMIT = 1000;
export const PRIVATE_FEED_EVENT_TAKE = CALENDAR_FEED_ENTRY_LIMIT;
export const ADMIN_FEED_ITEM_TAKE = CALENDAR_FEED_ENTRY_LIMIT;
