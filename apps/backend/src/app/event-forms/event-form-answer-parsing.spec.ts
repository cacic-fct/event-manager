...
import { parseAnswersJson, parseAnswersValue } from './event-form-answer-normalization';

describe('event form answer parsing', () => {
  it('parses stored answer values and rejects malformed non-list payloads', () => {
    expect(
      parseAnswersValue([{ elementId: 'feedback', value: 'Ótimo' }, { elementId: '', value: 'ignorado' }, null]),
