    ...
    return runSerializableSportsTransaction(this.prisma, async (tx) => {
      ...
      const team = await tx.sportsTeam.create({
        data: {
          ...
          logoObjectKey: input.includeLogo ? source.logoObjectKey : null,
          logoSha256: input.includeLogo ? source.logoSha256 : null,
          logoMimeType: input.includeLogo ? source.logoMimeType : null,
          logoSizeBytes: input.includeLogo ? source.logoSizeBytes : null,
