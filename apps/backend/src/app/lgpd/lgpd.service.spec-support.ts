...
function createPrismaMock() {
  ...
  return {
    ...
    prizeDrawExcludedPerson: findManyDelegate(),
    prizeDrawFrozenEntry: findManyDelegate(),
    prizeDrawSpinEntry: findManyDelegate(),
    prizeDrawSpin: findManyDelegate(),
...
function createTransactionMock() {
  ...
  return {
    ...
    prizeDrawExcludedPerson: deleteManyDelegate(),
    prizeDrawFrozenEntry: writeManyDelegate(),
