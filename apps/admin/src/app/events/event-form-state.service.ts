...
export class EventFormStateService {
  ...
  syncOnlineAttendanceControls(eventForm: ReturnType<EventFormStateService['createEventForm']>): void {
  ...
  syncCertificateControls(
    eventForm: ReturnType<EventFormStateService['createEventForm']>,
