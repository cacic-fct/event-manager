...
const meta: Meta<MergeCandidatesPageComponent> = {
...
type Story = StoryObj<MergeCandidatesPageComponent>;
...
export const CompactReviewQueue: Story = {
  ...Playground,
  name: 'Fila de revisão compacta',
