...
describe('PermissionsService', () => {
  ...
  it('reports missing permissions and tab readability', () => {
    ...
    expect(
      service.missing([Permission.Event.Read, Permission.EventAttendance.Read, Permission.EventAttendance.Read]),
    ).toEqual([Permission.Event.Read, Permission.EventAttendance.Read]);
  ...
  it('documents limited related person data without broad person permission inheritance', () => {
    expect(getPermissionIncludedDataSummary(Permission.EventAttendance.Read)).toContain(
      'Dados limitados da pessoa presente',
    );
