...
const meta: Meta<PermissionsPageComponent> = {
...
type Story = StoryObj<PermissionsPageComponent>;
...
export const CompactPermissionCatalog: Story = {
  ...Playground,
  name: 'Catálogo de permissões compacto',
