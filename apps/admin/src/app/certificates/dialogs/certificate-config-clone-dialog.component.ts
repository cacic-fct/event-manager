  ...
  template: `
    ...
    <div mat-dialog-content class="content">
      ...
      <section class="parts-section" aria-label="Informações para manter">
        ...
        <div class="part-grid">
          <mat-checkbox [formControl]="partControls.textContent"> Textos do certificado </mat-checkbox>
          <mat-checkbox [formControl]="partControls.recipientData"> Destinatário e campos </mat-checkbox>
          <mat-checkbox [formControl]="partControls.activeState"> Status </mat-checkbox>
          @if (data.config.issuedTo !== 'OTHER') {
            <mat-checkbox [formControl]="partControls.issuedPeople"> Pessoas já emitidas </mat-checkbox>
          } @else {
            <mat-checkbox [formControl]="partControls.manualPeople"> Lista de pessoas da emissão manual </mat-checkbox>
          }
        </div>
      </section>
    </div>
