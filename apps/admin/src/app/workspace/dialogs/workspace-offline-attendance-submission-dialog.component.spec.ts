...
describe('WorkspaceOfflineAttendanceSubmissionDialogComponent', () => {
...
async function createFixture({
  ...
  fixture: ComponentFixture<WorkspaceOfflineAttendanceSubmissionDialogComponent>;
}> {
  await TestBed.configureTestingModule({
    imports: [WorkspaceOfflineAttendanceSubmissionDialogComponent],
    providers: [
  ...
  const fixture = TestBed.createComponent(WorkspaceOfflineAttendanceSubmissionDialogComponent);
