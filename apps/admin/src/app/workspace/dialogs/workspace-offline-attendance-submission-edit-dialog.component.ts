...
export interface WorkspaceOfflineAttendanceSubmissionEditDialogResult {
  personId: string;
}
...
export class WorkspaceOfflineAttendanceSubmissionEditDialogComponent {
  private readonly dialogRef = inject(
    MatDialogRef<
      WorkspaceOfflineAttendanceSubmissionEditDialogComponent,
      WorkspaceOfflineAttendanceSubmissionEditDialogResult | null
    >,
  );
  private readonly peopleApi = inject(PeopleApiService);
  private readonly formBuilder = inject(FormBuilder);

  readonly data = inject<WorkspaceOfflineAttendanceSubmissionEditDialogData>(MAT_DIALOG_DATA);
