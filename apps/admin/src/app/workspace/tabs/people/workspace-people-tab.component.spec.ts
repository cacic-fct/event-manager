...
import type { PermissionGrantDraft } from '../../../shared/services/workspace-people-permission-grants';
...
describe('WorkspacePeopleTabComponent permissions section', () => {
...
async function renderComponent(options: RenderOptions = {}): Promise<{
  ...
  element: HTMLElement;
  fixture: ComponentFixture<WorkspacePeopleTabComponent>;
  ...
  await TestBed.configureTestingModule({
    imports: [WorkspacePeopleTabComponent],
    providers: [
  ...
  const fixture = TestBed.createComponent(WorkspacePeopleTabComponent);
  fixture.detectChanges();
...
async function openTab(fixture: ComponentFixture<WorkspacePeopleTabComponent>, element: HTMLElement, label: string) {
