...
describe('WorkspacePeopleTabComponent permission grants integration', () => {
  let fixture: ComponentFixture<WorkspacePeopleTabComponent>;
  ...
  beforeEach(async () => {
    ...
    fixture = TestBed.createComponent(WorkspacePeopleTabComponent);
