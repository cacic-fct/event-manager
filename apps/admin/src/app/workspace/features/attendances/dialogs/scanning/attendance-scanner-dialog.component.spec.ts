import { AttendanceScannerDialogComponent } from './attendance-scanner-dialog.component';

describe('AttendanceScannerDialogComponent labels', () => {
  it('labels standalone subscribers with confirmed status', () => {
    const component = Object.create(AttendanceScannerDialogComponent.prototype) as {
