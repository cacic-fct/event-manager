...
describe('WorkspaceOfflineAttendanceSubmissionEditDialogComponent', () => {
...
async function createFixture({
  ...
  component: WorkspaceOfflineAttendanceSubmissionEditDialogComponent;
  dialogRef: { close: ReturnType<typeof vi.fn> };
  fixture: ComponentFixture<WorkspaceOfflineAttendanceSubmissionEditDialogComponent>;
}> {
  const api = {
  ...
  await TestBed.configureTestingModule({
    imports: [WorkspaceOfflineAttendanceSubmissionEditDialogComponent],
    providers: [
  ...
  const fixture = TestBed.createComponent(WorkspaceOfflineAttendanceSubmissionEditDialogComponent);
