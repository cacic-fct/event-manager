...
} from '../dialogs/clone-asset-dialog.component';
import {
...
import { EventPeopleService } from '../../attendances/data-access/event-people.service';
import { EventFormStateService } from './event-form-state.service';
import { MajorEventsService } from '../../major-events/data-access/major-events.service';
import { PermissionsService } from '../../permissions/data-access/permissions.service';
import { PlacePresetsService } from '../../places/data-access/place-presets.service';
import { ShellUiService } from '../../../shell/data-access/ui.service';
import {
...
export class EventsService {
  ...
  readonly placePresetsService = inject(PlacePresetsService);
