...
import { WorkspacePeoplePermissionGrantEditor } from './workspace-people-permission-grant-editor';

export abstract class WorkspacePeoplePermissionGrantPersistence extends WorkspacePeoplePermissionGrantEditor {
