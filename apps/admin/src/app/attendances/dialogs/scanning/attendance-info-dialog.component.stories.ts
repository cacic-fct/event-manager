...
import { AttendanceInfoDialogComponent } from './attendance-info-dialog.component';
...
class AttendanceInfoDialogStoryHostComponent {
  private readonly injector = inject(Injector);

  readonly component = AttendanceInfoDialogComponent;
