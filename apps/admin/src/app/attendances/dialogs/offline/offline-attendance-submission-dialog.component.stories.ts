...
class OfflineAttendanceSubmissionDialogStoryHostComponent {
  ...
  readonly component = OfflineAttendanceSubmissionDialogComponent;
...
export const ResolutionError: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    await expect(
      await canvas.findByText('Corrija os dados da pessoa antes de aprovar esta presença off-line.'),
    ).toBeVisible();
