        ...
        <div class="person-lookup">
          <mat-form-field>
            ...
            <button
              ...
              matSuffix
              type="button"
              aria-label="Executar busca de pessoa"
              (click)="searchPeople()">
              @if (isSearching()) {
...
export class OfflineAttendanceSubmissionEditDialogComponent {
  private readonly dialogRef = inject(
    MatDialogRef<OfflineAttendanceSubmissionEditDialogComponent, OfflineAttendanceSubmissionEditDialogResult | null>,
  );
  ...
  constructor() {
    this.personSearch.valueChanges.pipe(takeUntilDestroyed()).subscribe((value) => {
