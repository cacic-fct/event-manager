...
const meta: Meta<MajorEventAttendancesComponent> = {
...
type Story = StoryObj<MajorEventAttendancesComponent>;
...
export const CompactReconciliation: Story = {
  ...Playground,
  name: 'Conciliação compacta do grande evento',
