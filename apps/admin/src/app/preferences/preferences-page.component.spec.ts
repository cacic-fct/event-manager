...
describe('PreferencesPageComponent', () => {
  ...
  beforeEach(async () => {
    ...
    api = {
      ...
      rotateSuperAdminKey: vi
        .fn()
        .mockReturnValue(of(superAdminSettingsFixture({ feedPath: '/api/calendar/admin/super-admin/rotated.ics' }))),
    };
    dialog = {
  ...
  async function createComponent(): Promise<{
    ...
    fixture: ComponentFixture<PreferencesPageComponent>;
  }> {
...
function adminSettingsFixture(
  overrides: Partial<CurrentUserAdminCalendarFeedSettings> = {},
): CurrentUserAdminCalendarFeedSettings {
  return {
    enabled: true,
    feedPath: '/api/calendar/admin/feeds/admin-key.ics',
...
function superAdminSettingsFixture(
  overrides: Partial<SuperAdminCalendarFeedSettings> = {},
): SuperAdminCalendarFeedSettings {
  return {
    enabled: true,
