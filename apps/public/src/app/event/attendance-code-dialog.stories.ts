...
import { AttendanceCodeDialog } from './attendance-code-dialog';

const meta: Meta<AttendanceCodeDialog> = {
  component: AttendanceCodeDialog,
  title: 'Public/Event/Attendance Code Dialog',
  tags: ['autodocs'],
  parameters: {
    layout: 'fullscreen',
    a11y: { test: 'todo' },
...
type Story = StoryObj<AttendanceCodeDialog>;
