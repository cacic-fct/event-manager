...
Colete a presença oportunamente, como no início ou no final do evento, para evitar esquecimentos e garantir a precisão dos dados.
...
Só colete as presenças no papel para lançar no sistema depois em casos extremos, como falta de internet ou falha no sistema.
