# Criar um grupo de eventos

Crie o grupo de eventos _antes_ de criar os eventos que o compõem.  
Na criação do evento, você precisará indicar um grupo já existente.
