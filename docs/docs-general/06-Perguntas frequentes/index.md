...
## Quem pode usar o CACiC Event Manager?
...
### Posso usar o CACiC Event Manager para organizar a venda do meu kit bixo?
...
### Posso usar o CACiC Event Manager para meu projeto de extensão?
...
### Posso usar o CACiC Event Manager para meu evento do movimento estudantil?
...
É permitido usar o CACiC Event Manager para organizar viagens para eventos do ME, contanto que o evento seja relacionado com a FCT ou com a Unesp e que os usuários sejam exclusivamente estudantes da FCT.

### Posso usar o CACiC Event Manager para festas?

> Aniversário, confraternização, churrasco, formatura, eventos de república, etc.

Não.

## Com quem falo para poder organizar um evento no CACiC Event Manager?

Verifique a disponibilidade com o [CACiC](https://cacic-fct.github.io), o Centro Acadêmico de Ciência da Computação.

## Uso dos dados

### Posso usar os dados do CACiC Event Manager para uma pesquisa?

Depende.

É necessário entrar em contato com o CACiC.  
O CA seguirá o que consta na seção de [Procedimentos de solicitação de dados](/Administra%C3%A7%C3%A3o/Procedimentos/Dados/Fornecimento/Solicita%C3%A7%C3%A3o%20de%20conjuntos%20dados). Logo, a resposta não dependerá do CA.
