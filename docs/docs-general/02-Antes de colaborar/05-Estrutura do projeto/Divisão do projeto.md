...
Não se admite a modularização das funcionalidades do projeto em repositórios diferentes, com excessão daquilo que fuja do escopo de "gerenciamento de eventos", como é o caso do CACiC Account Manager.
