...
Em comunicações para a comunidade, deve-se usar o nome "CACiC Eventos", para facilitar a compreensão do público.
...
1. Abolir o uso de papel, seja na confecção de crachás, certificados ou na coleta de presença:
    ...
    - Crachás comprometiam parte significativa do orçamento de eventos e geravam lixo desnecessário.

### Alterações com o tempo

Antes, o FCT App possuía o propósito de ser um "hub" completo para os alunos da FCT, com tudo em um só lugar.
