...
Os _lead developers_ exercem o papel de auditoria externa _voluntária_ para evitar o problema descrito na seção [deficiências evidentes](https://cacic.dev.br/docs/Recursos/Servidores/FCT-DTI-X-01/Vulnerabilidades#deficiências-evidentes).  
